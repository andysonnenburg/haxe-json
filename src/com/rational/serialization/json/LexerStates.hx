...
class LexerStates {
	...
	public static inline var LEADING_FRACTIONAL:LexerState = 7;
	public static inline var FRACTIONAL:LexerState = 8;
	public static inline var LEADING_EXPONENTIAL:LexerState = 9;
	public static inline var EXPONENTIAL:LexerState = 10;
	public static inline var NUMBER:LexerState = 11;
}
