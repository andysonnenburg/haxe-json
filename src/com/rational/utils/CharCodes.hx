...
class CharCodes {
	...
	public static inline var LEFT_BRACE:Int = 123;

	public static inline var RIGHT_BRACE:Int = 125;

	public static inline var LEFT_BRACKET:Int = 91;

	public static inline var RIGHT_BRACKET:Int = 93;
	...
	public static inline var REVERSE_SOLIDUS:Int = 92;
